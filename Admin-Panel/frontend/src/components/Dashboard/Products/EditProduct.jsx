...
function EditProduct({ show, handleUpdate, closeModal, property }) {
  ...
  useEffect(() => {
    ...
    setPropertyAddress(property?.product_address || "");
    setPropertyLookingFor(property?.product_lookingFor || "");
    setPropertyLocation(property?.product_location || "");
    setPropertySize(property?.product_propertySize || "");
    setPropertyBedroom(property?.product_bedroom || "");
    setPropertyBathroom(property?.product_bathroom || "");
    setPropertyBudget(property?.product_budget || "");
  }, [property]);
  ...
  async function updateProduct(e) {
    ...
    try {
      const response = await axios.put(
        `http://localhost:7000/api/v1/property/updateProperty/${property.product_id}`,
        formData,
        {
          headers: {
      ...
      handleUpdate(response.data.result);
          ...
          <div className="customRegisterInnerDiv">
            <form onSubmit={updateProduct}>
              <Modal.Header closeButton>
                <div className="head">Edit Your Property</div>
              </Modal.Header>
